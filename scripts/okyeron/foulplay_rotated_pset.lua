...
function init()
  ...
  loadpset(presets[3])
  --params:read("okyeron/foulplay606.pset")
  --params:read("okyeron/foulplay808.pset")
  --params:read("okyeron/foulplay909.pset")
...
function gridkey(x, y, state)
  ...
  -- 3rd column
  if x == 3 and y == 1 and state==1 then -- make 1-3 start/stop
    key(2,1)
  end
  if x == 3 and y == 2 and state == 1 then -- make 2-3 sync
    reset_pattern()
  end
  if x == 3 and y == 6 and state==1 then -- make 6-3 - 8-3 preset select
   loadpset(presets[1])
  end
   if x == 3 and y == 7 and state==1 then -- make 6-3 - 8-3 preset select
   loadpset(presets[2])
  end
  if x == 3 and y == 8 and state==1 then -- make 6-3 - 8-3 preset select
   loadpset(presets[3])
  end
